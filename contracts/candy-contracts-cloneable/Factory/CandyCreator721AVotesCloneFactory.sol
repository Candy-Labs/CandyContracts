...
import "./CandyCreator721AVotes.sol";
...
contract CandyCreator721AVotesCloneFactory {
    ...
    function create721AVotes(string name, string symbol, string placeholderURI, uint256 mintPrice, uint256 mintSize, bytes32 whitelistMerkleRoot) external returns (address) {
