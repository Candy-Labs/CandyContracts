...
contract CandyCreator721ACloneFactory {
    ...
    external returns (address) {
        ...
        CandyCreator721AUpgradeable(clone).initialize(name, symbol, _placeholderURI, _mintPrice, _mintSize, splitAddresses, splitShares, _whitelistMerkleRoot, _maxPublicMints, _maxWhitelistMints, candyWallet, msg.sender);
